...
/*   Updated: 2019/02/19 01:23:52 by prastoin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "lem_in.h"

int		ft_fill_power(t_room *room, t_algo *algo, int cmt, int i)
{
	int j;
...
int		ft_call_power(t_room *room, t_algo *algo, t_all *all)
{
	...
	while (1)
	{
		if (ft_fill_power(room, algo, 1, 0) == -1)
			break ;
